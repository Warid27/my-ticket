    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Edit Ticket</h3>
                <p class="text-subtitle text-muted">Update ticket information</p>
            </div>
            ...
            <div class="card-body">
                <form method="POST" action="index.php?page=ticket&action=update">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name" value="<?= htmlspecialchars($ticket['name']) ?>" required>
                    </div>
                    <div class="form-group mb-3">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number" class="form-control" id="quota" name="quota" value="<?= $ticket['quota'] ?>" required>
                    </div>

    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Add Venue</h3>
                <p class="text-subtitle text-muted">Create a new venue</p>
            </div>
            ...
            <div class="card-body">
                <form method="POST" action="index.php?page=venue&action=store">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea class="form-control" id="address" name="address" rows="3" placeholder="Enter venue address"></textarea>
                    </div>
                    <div class="form-group mb-3">

    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Edit Venue</h3>
                <p class="text-subtitle text-muted">Update venue information</p>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.php?page=dashboard&action=admin">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="index.php?page=venue&action=index">Venues</a></li>
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Venue Information</h4>
            </div>
            <div class="card-body">
                <form method="POST" action="index.php?page=venue&action=update">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea class="form-control" id="address" name="address" rows="3"><?= htmlspecialchars($venue['address']) ?></textarea>
                    </div>
                    <div class="form-group mb-3">
                    ...
                    <div class="d-flex gap-2 mt-3">
                        ...
                        <a href="index.php?page=venue&action=index" class="btn btn-secondary">
